...
@Component({
  ...
  template: `
  <div *ngIf="collapsed && data.items && data.items.length > 0" class="subsub-nav-wapper">
    <div class="subsub-nav-hr"></div>
    <ul [@submenu]="expanded
          ? {value: 'visible', 
          ...
          class="sublevel-nav"
        >
        <li *ngFor="let item of data.items" class="sublevel-nav-item sub-level-nav-config">
